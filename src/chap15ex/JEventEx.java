...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	class MyPanel extends JPanel {
		private JLabel la = new JLabel("15장 연습문제");
		...
		public MyPanel() {
			...
			btn[4].addActionListener(new ActionListener() {	//3
				public void actionPerformed(ActionEvent e) {
					new JEventEx();
				}
			});
			...
			btn[6].addActionListener(new ActionListener() {//4
				public void actionPerformed(ActionEvent e) {
					new JEventEx();
				}
			});
			...
			btn[8].addActionListener(new ActionListener() {//5
				public void actionPerformed(ActionEvent e) {
					new JEventEx();
				}
			});
